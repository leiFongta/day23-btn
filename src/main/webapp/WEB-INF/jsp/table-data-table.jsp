  ...
  <body class="app sidebar-mini rtl">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="adduser()">
					确认提交
				</button>
			</div>
		</div>
    ...
    <script type="text/javascript">
      ...
      $(function(){
    	 ...
    	 var $btn=$('<button type="button" id="add" class="btn btn-primary " data-toggle="modal" data-target="#myModal" onclick="resetform()">新增</button>'); 
      ...
      function operateFormatter(value,row,index){
      	...
      	return [
					'<button type="button" id="update" class="btn btn-warning" data-toggle="modal" data-target="#myModal">修改</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
      ...
      function adduser(){
    	  var parm=$("#userform").serialize();
    	  if($("#userform input")[0].value==''){
	    	  $.post("adduser",parm);
	    	  location.href="table-data-table";
	    	   		      		  
    	  }else{
    		  
    		  $.post("updateuser",parm)
	    	  location.href="table-data-table";     		    
    	  }
      }
      ...
      window.operateEvents = {
    	        'click #update': function (e, value, row, index) {
    	        	var $userform = $("#userform input");
    	        	$userform[0].value=row.id;
    	        	$userform[1].value=row.nickname;
    	        	$userform[2].value=row.age;
    	        	$userform[5].value=row.address;
    	        	$userform[6].value=row.phone;
    	        	if(row.sex===1){
    	        		$userform[3].checked=true;
    	        	}else{
    	        		$userform[4].checked=true;
    	        	}	        	
